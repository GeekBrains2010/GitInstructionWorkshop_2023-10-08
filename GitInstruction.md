...
Совместная работа в системах контроя версий нужна для корректировки отдельных частей программы разными специалистами, не затрагивая изменения друг друга и рабочую версию программы.
