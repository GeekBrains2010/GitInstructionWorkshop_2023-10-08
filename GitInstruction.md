...
Делать требуется все аккуратно и дотошно
## Что это и для чего нужна система контроля версий?

### Что такое система контроля версий?
Эта система позволяет хранить историю изменения файлов, с авторами. Записал эту строчку 555 пока ничего
новая строка в эпохе
